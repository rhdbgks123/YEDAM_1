...
<title>아이디/비밀번호 찾기</title>
    <link href="./css/find_user.css" rel="stylesheet" />
</head>
<body>
    ...
    <form class="wrapper-box" id = "registerForm" name="registerForm" action="registUser.do" method="post">
            ...
            <ul>
                ...
                <li>
                    ...
                    <button type="button" id="sendmail" style="width: 150px; margin: 0;">인증번호받기</button>
                </li>
                <li>
                    <label for="userId">인증번호<span class="redaccent">*</span></label>
                    <input type="text" id="signkey" name="signkey" required style="width: 400px;">
                    <button type="button" id="signcheck" style="width: 100px; margin: 0;">인증</button>
                </li>
                <div id="regbutton">
                    <li>
                        <button type="submit" class="btn btn-submit btn-default pull-right">메일발송</button>
                    </li>
                </div>
            </ul>
    </form>
